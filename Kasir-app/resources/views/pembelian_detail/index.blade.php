            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="tampil-terbilang" style="color: black">Rp 100.000</div>
                            </div>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary btn-sm btn-flat pull-right btn-simpan">Simpan
                            Transaksi</button>
                    </div>
                </div>
            </div>
        ...
        <script>
            ...
            $(function() {
                ...
                $(document).on('input', '.quantity', function() {
                    ...
                    if (jumlah < 1) {
                        $(this).val(1);
                        swal("Perhatian", "Tidak boleh isi jumlah kurang dari 1", "info");
                        return;
                    }
                    if (jumlah > 10000) {
                        $(this).val(10000);
                        swal("Perhatian", "Tidak boleh isi jumlah lebih dari  10000", "info");
                        return;
                    }
                    $.post(`{{ url('/pembelian_detail') }}/${id}`, {
                        ...
                        .fail(errors => {
                            swal("Perhatian", "harap isi kolom jumlah", "info");
                            return;
                        });
                });
